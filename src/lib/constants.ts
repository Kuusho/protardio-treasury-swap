 ...
 */
export const APP_NAME: string = 'protard';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'coolest farcaster pfp\'s';
 ...
 */
export const APP_OG_IMAGE_URL: string = `${APP_URL}/assets/images/banner.jpg`;
 ...
 */
export const APP_SPLASH_BACKGROUND_COLOR: string = '#0a0a0a';
 ...
 */
export const APP_BUTTON_TEXT: string = 'Launch Protardio';
